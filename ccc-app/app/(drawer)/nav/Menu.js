...
function CustomDrawerContent({
  ...
  const screens = [
    ...
    { title: "Woman", navigateTo: "WomanDrawer" },
    { title: "Man", navigateTo: "ManDrawer" },
    { title: "Kids", navigateTo: "KidsDrawer" },
    { title: "New Collection", navigateTo: "New Collection" },
    { title: "Profile", navigateTo: "ProfileDrawer" },
    { title: "Settings", navigateTo: "SettingsDrawer" },
    { title: "Components", navigateTo: "ComponentsDrawer" },
  ];
  return (
    <Block
